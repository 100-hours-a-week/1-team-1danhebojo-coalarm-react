...
export const Dashboard = () => {
  return (
    <div className="sidebar-notice" style={{ overflowY: "auto", height: "100%" }}>
      <div className="main-sidebar-notice">
        <div className="overlap">
          ...
          <Component1606 className="component-1606-instance" frameClassName="view-2" />
          <Component1609 className="component-1609-instance" component1607MainIconPropertyCloseClassName="view-3" />
          ...
          <Component1611 className="component-1611-instance" frameClassName="component-1611-2" />
          <Macd className="MACD-instance" />
          <Rsi className="RSI-instance" property1="variant-2" />
          <Component1614 className="component-1614-instance" property1="variant-3" />
          <SidebarComponent />
          <div className="view-5">
            <div className="frame-20">
              <Property1Noti className="solid-exclamation" color="#F8F8F8" opacity="0.972549" />
            ...
            <UserInterfaceClose className="user-interface-close-3" color="#F8F8F8" opacity="0.972549" />
          </div>
        </div>
      </div>
    </div>
